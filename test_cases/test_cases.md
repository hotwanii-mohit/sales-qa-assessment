...
**Scenario:** Validate total amount spent per country for pending delivery status  
...
**Scenario:** Validate total transactions and total amount per customer along with product details  
...
**Scenario:** Identify the most purchased product in each country  
...
**Scenario:** Identify most purchased product for customers below 30 and above 30  
...
**Scenario:** Identify the country with lowest transactions and total sales  
